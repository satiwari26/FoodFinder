    ...
    <>
      <div className="resources">
        <div className="resources__container">
            <p className="resources__title">List of Cal Poly Resources!</p>
          ...
          <p className="resources__description"> activeIndex: {activeIndex} </p>
